...
objs = p.loadSDF("/Users/vigneshbalaji/atlas-humanoid-robot/data/botlab/botlab.sdf", globalScaling=2.0)
zero=[0,0,0]
...
p.loadURDF("data/boston_box.urdf",[-2,3,-2], useFixedBase=True)

p.resetDebugVisualizerCamera( cameraDistance=1, cameraYaw=148, cameraPitch=-9, cameraTargetPosition=[0.36,5.3,-0.62])

p.loadURDF("data/boston_box.urdf",[0,3,-2],useFixedBase=True)
